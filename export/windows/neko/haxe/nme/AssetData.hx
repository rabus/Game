...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/Fonts/kenpixel.ttf", "assets/Fonts/kenpixel.ttf");
			type.set ("assets/Fonts/kenpixel.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/Fonts/kenpixel_blocks.ttf", "assets/Fonts/kenpixel_blocks.ttf");
			type.set ("assets/Fonts/kenpixel_blocks.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/Fonts/kenpixel_future.ttf", "assets/Fonts/kenpixel_future.ttf");
			type.set ("assets/Fonts/kenpixel_future.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/Fonts/kenpixel_future_square.ttf", "assets/Fonts/kenpixel_future_square.ttf");
			type.set ("assets/Fonts/kenpixel_future_square.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/Fonts/kenpixel_high.ttf", "assets/Fonts/kenpixel_high.ttf");
			type.set ("assets/Fonts/kenpixel_high.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/Fonts/kenpixel_high_square.ttf", "assets/Fonts/kenpixel_high_square.ttf");
			type.set ("assets/Fonts/kenpixel_high_square.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/Fonts/kenpixel_mini.ttf", "assets/Fonts/kenpixel_mini.ttf");
			type.set ("assets/Fonts/kenpixel_mini.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/Fonts/kenpixel_mini_square.ttf", "assets/Fonts/kenpixel_mini_square.ttf");
			type.set ("assets/Fonts/kenpixel_mini_square.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/Fonts/kenpixel_square.ttf", "assets/Fonts/kenpixel_square.ttf");
