...
class ApplicationMain
{
	...
	public static function main()
	{
		...
		wx.App.boot(function()
		{
			...
			frame = wx.Frame.create(null, null, "Game", null, { width: 800, height: 480 });
			...
			var hasMain = false;
			for (methodName in Type.getClassFields(org.rabus.game.Main)) {
				if (methodName == "main") {
					hasMain = true;
					break;
				}
			...
			if (hasMain) {
				...
				var instance = Type.createInstance(org.rabus.game.Main, []);
			}
			
			/*if (Reflect.hasField(org.rabus.game.Main, "main")) {
				org.rabus.game.Main.main();			
			}*/
